...
var firebaseConfig = {
  apiKey: "AIzaSyBepwpwBP4bdzkwNjd5SZsDwFxC6R-bPnw",
  authDomain: "palancer-store.firebaseapp.com",
  projectId: "palancer-store",
  storageBucket: "palancer-store.appspot.com",
  messagingSenderId: "308770744200",
  appId: "1:308770744200:web:dc9d1d46a2d8007367bc3d"
}; // Initialize Firebase

var app = (0,firebase_app__WEBPACK_IMPORTED_MODULE_0__.initializeApp)(firebaseConfig); // Notification.requestPermission().then(permission=> {
...
(0,firebase_messaging__WEBPACK_IMPORTED_MODULE_1__.getToken)(messaging, {
  vapidKey: 'BAz4VJqzR0m9bZ1MXWlpga4Zj_2jixc5bf1U9Rr_Pc5W3U4l7lQXDAovSTqnjG7hSi4BPpCJwj_n70qTSssmZvE'
